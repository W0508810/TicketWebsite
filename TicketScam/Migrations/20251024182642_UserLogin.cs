        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Show_ShowId",
                        column: x => x.ShowId,
                        principalTable: "Show",
                        principalColumn: "ShowId");
                    table.ForeignKey(
                        name: "FK_Tickets_Venue_VenueId",
                        column: x => x.VenueId,
            ...
            migrationBuilder.InsertData(
                table: "Venue",
                columns: new[] { "VenueId", "Location", "VenueCapacity", "VenueName" },
                values: new object[,]
                {
                    { 1, "Halifax, NS", 10000, "Scotia Bank Centre" },
                    { 2, "Halifax, NS", 1040, "Rebecca Cohn Auditorium" }
                });
